...
Um **Subdomínio** é uma área distinta dentro do domínio de negócio global.
...
- **Natureza Primária**: Um **limite linguístico** onde os termos têm significados específicos
- **Regra Chave**: Dentro do limite, todos os termos da Linguagem Ubíqua têm significado inequívoco
- **Contém**: Modelo de domínio, esquema de banco de dados (se projetado para o modelo), componentes de UI, Serviços de Aplicação, Web services
